...
int main(){
    char expr[100];
    char c, operator;
    int i = 0;    //is used for traversing the expression
    int j = 0;    //is used for traversing the filling the temp
    int count;    //is used for counting the number of decimal
    int flag;     //is used for indicating that the decimal point is encountered i.e flag = 1
